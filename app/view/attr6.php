    ...
    <div class="mainsection">
      ...
      <div class="leftsidebar">
        ...
        <div class="headlabel">
          ...
          <div class="dropdown navbar-right">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
              ...
              <li class="active"><a href="attr6.php">Attributes - title</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="bodylabel">
          ...
          <pre class="prettyprint">&lt;p title="intro paragraph"&gt;Content here &lt;/p&gt;</pre>
          <ol id="attrInfo">
            <li>The title attribute specifies extra information about an element.</li>
            <li>The information is most often shown as a tooltip text when the mouse moves over the element.</li>
          </ol>
        </div>
        ...
        <div class="fullwidth">
          <div class="instructions">
            <h3>Instructions</h3>
            <ol>
              <li>Lets finish up by adding a title attribute, <strong>title</strong> of <code>intro paragraph</code> - (this will give us a neat little tooltip on hover) - to our <code>p</code> tag, on 17</li>
            </ol>
          </div>
        </div>
        ...
        <div class="solution">
          ...
          <br>
          <div class="answer">
            <h4 class="text-center">Add this code on line 17 to complete the exercise</h4>
            <pre class="prettyprint">&lt;p title="intro paragraph"&gt;Content Here&lt;/p&gt;</pre>
          </div>
          <div class="text-center bg-info">
            <a href="http://www.w3schools.com/tags/att_global_title.asp" target="_blank">Find More on HTML title Attribute</a>
          </div>
        </div>
      ...
      <div class="centersection">
        <div class="tabs">
          ...
          <div id="tabs-1">
            <ol>
              ...
              <li><span class="indent3 red">&lt;div</span> <span class="yellow">class=</span><span class="pink">"box"</span><span class="red">&gt;</span></li>
              <li><span class="indent4 red">&lt;img</span> <span class="yellow">src="</span><span class="pink">placholder.jpg"</span> <span class="yellow">alt="</span><span class="pink">placholder image"</span><span class="red">&gt;</span></li>
              <li class="userAnswerAttr"><span class="indent4 userId">&lt;p</span><span class="userAnswerId" contenteditable="true">&gt;</span><span class="userAnswerConent" contenteditable="true">Content Here</span><span>&lt;/p&gt;</span></li>
              <li><span class="indent3 red">&lt;/div&gt;</span></li>
        ...
        <div class="metaCorrect">
          <div class="alert alert-success text-center">
            Good Job! You completed adding a title attribute - to an paragraph (p) tag.
            <br>
            <a href="../../index.html"> Complete - Thanks for testing! <i class="fa fa-angle-double-right"></i></a>
          </div>
        </div>
        ...
        <footer>
          <button class="savesubmit" onclick="checkAttr6()">Submit Code</button>
          <button class="resetcode" onclick="resetAttrCode6()">Reset Code</button>
        </footer>
